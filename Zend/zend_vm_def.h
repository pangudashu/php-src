...
ZEND_VM_HANDLER(198, ZEND_DEFER_SET, UNUSED, UNUSED)
{
    printf("this will be executed as last\n");
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(199, ZEND_DEFER_CALL, UNUSED, UNUSED)
{
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(200, ZEND_DEFER_CALL_DONE, UNUSED, UNUSED)
{
	ZEND_VM_NEXT_OPCODE();
}
